...
ui.hr(style="margin-top:20px; margin-bottom:20px; border-top:2px solid #87CEEB"),
                ...
                ui.input_action_button("plot_spectra", ui.HTML("Plot & Compare<br>two spectra"), style="font-size:24px; padding:20px 40px; width:370px; height:100px; margin-top:10px; margin-right:50px"),
                ...
                ui.input_action_button("run_parameter_tuning_grid", ui.HTML("Tune parameters<br>(Grid search)"), style="font-size:24px; padding:20px 40px; width:420px; height:100px; margin-top:10px; margin-right:50px"),
                ui.input_action_button("run_parameter_tuning_DE", ui.HTML("Tune parameters<br>(DE optimization)"), style="font-size:24px; padding:20px 40px; width:470px; height:100px; margin-top:10px; margin-right:50px"),
ui.hr(style="margin-top:20px; margin-bottom:20px; border-top:2px solid #87CEEB"),
