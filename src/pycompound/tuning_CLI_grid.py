...
parser.add_argument('--output_path', type=str, default=f'{Path.cwd()}/output_tuning.txt', metavar='\b', help='Output TXT file containing one row for each parameter set used along with its corresponding accuracy. If no argument is passed, then this TXT file is written to the current working directory with the filename \'output_all_similarity_scores\'.txt.')
